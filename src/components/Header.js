...
export default async function Header() {
  ...
  return (
    <header className="bg-gray-800 border-b py-2">
      <div className="max-w-6xl mx-auto px-4 flex flex-wrap justify-between items-center">
        ...
        <nav className="hidden sm:flex justify-center gap-10 text-slate-300 text-sm flex-grow font-bold">
          <Link href="/about" className="hover:underline text-white">About</Link>
          <Link href="/pricing" className="hover:underline text-white">Pricing</Link>
